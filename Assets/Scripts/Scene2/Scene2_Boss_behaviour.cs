...
public class Scene2_Boss_behaviour : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!InsideOfLimits() && !inRange && !anim.GetCurrentAnimatorStateInfo(0).IsName("S2_Boss_Attack"))
        {
            SelectTarget();
    ...
    void Move()
    {
        ...
        if (!anim.GetCurrentAnimatorStateInfo(0).IsName("S2_Boss_Attack"))
        {
